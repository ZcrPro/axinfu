package com.zhihuianxin.xyaxf.app.customview;
/*
...
public class OverScrollView extends FrameLayout implements OnTouchListener
{
	...
	protected void onScrollChanged(int leftOfVisibleView, int topOfVisibleView, int oldLeftOfVisibleView, int oldTopOfVisibleView)
	{
        ...
        if (topOfVisibleView-oldTopOfVisibleView<20){
            return;
        }

		if (oldTopOfVisibleView < topOfVisibleView && topOfVisibleView - oldTopOfVisibleView > SCROLLLIMIT) {
			if (onScrollToTop != null)
				onScrollToTop.scrollToTop();
		}

		if (scrollViewListener != null) {
			scrollViewListener.onScrollChanged(this, leftOfVisibleView, topOfVisibleView, oldLeftOfVisibleView, oldTopOfVisibleView);
		}
	...
	public interface ScrollViewListener {
		void onScrollChanged(OverScrollView scrollView, int x, int y, int oldx, int oldy);
	}

	public void setOnSc(ScrollViewListener scrollViewListener){
