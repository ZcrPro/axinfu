...
/**
 * Created by zcrpro on 2018/3/12.
 */

public class SetFingerActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.set_finger_activity);
    ...
    private void init() {
        ...
        linkXieyi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(SetFingerActivity.this, UnionSetGestureActivity.class));
                finish();
            }
        });
        ...
        tiaoguo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //弹窗
                LockDialog lockDialog = new LockDialog(SetFingerActivity.this);
                lockDialog.show();
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isFinger()) {
                    if (errorTimes < 5) {
                        scanDialog = new AlertDialog.Builder(SetFingerActivity.this)
                                .setTitle("指纹解锁")
                                .setMessage("请扫描指纹")
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(SetFingerActivity.this)
                                .setTitle("指纹解锁")
        ...
        okBnt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Util.isEmpty(pwdEdit.getText().toString().trim())) {
                    Toast.makeText(SetFingerActivity.this, "请输入登录密码", Toast.LENGTH_SHORT).show();
                } else {
...
//            Toast.makeText(SetFingerActivity.this, "验证失败", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onAuthenticationFailed() {
            ...
            if (errorTimes >= 5) {
                ...
                reScanDialog = new AlertDialog.Builder(SetFingerActivity.this)
                        .setTitle("指纹解锁")
