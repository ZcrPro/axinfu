...
public class SwipeRefreshAndLoadMoreLayoutStick extends SwipeRefreshLayout implements AbsListView.OnScrollListener {
    ...
    public SwipeRefreshAndLoadMoreLayoutStick(Context context) {
        this(context, null);
    }

    public SwipeRefreshAndLoadMoreLayoutStick(Context context, AttributeSet attrs) {
        super(context, attrs);
        //表示触发事件的最小距离
